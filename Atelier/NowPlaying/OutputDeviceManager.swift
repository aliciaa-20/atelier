...
/// CoreAudio's `AudioObject` property API. No special permission needed —
/// this isn't microphone input, just the same default-output selection
/// available from the menu-bar volume control.
